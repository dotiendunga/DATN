...
ser_control = serial.Serial('/dev/ttyACM1', 115200, timeout=5)  // connect with serial ESP
ser_control.write(b'$')                                         // Send char start to ESP

ser_gps = serial.Serial('/dev/ttyACM0', 115200, timeout=5)  // connect with serial GPS 
ser_gps.write(b'$')                                         // Send char start to GPS
