...
class RootApplication(tk.Tk):
    def __init__(self):
        ...
        # BackGround:
        self.image = Image.open(r"image/background.jpg")
...
class Frame2(tk.Frame):
    def __init__(self, master):
        ...
        self.map_widget.place(relx=0.5, rely=0.97, anchor=S)
    ...
    def update_realtime_frame2(self):
        while not self.data_queue.empty():
            ...
            #push data to hivemq
            send_data_to_hivemq(str(Real_time), str(Speed), str(Latitude_values), str(Longitude_values), self.data.true_course)
